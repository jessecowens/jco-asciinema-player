...
class Jco_Asciinema_Player {
	 ...
	 * @since    1.0.0
	 * @access   protected
	 * @var      Jco_Asciinema_Player_Loader    $loader    Maintains and registers all hooks for the plugin.
	 */
	protected $loader;
	 ...
	 *
	 * - Jco_Asciinema_Player_Loader. Orchestrates the hooks of the plugin.
	 * - Jco_Asciinema_Player_i18n. Defines internationalization functionality.
	 * - Jco_Asciinema_Player_Admin. Defines all hooks for the admin area.
	 * - Jco_Asciinema_Player_Public. Defines all hooks for the public side of the site.
	 *
	...
	private function load_dependencies() {
		 ...
		 * core plugin.
		 */
		require_once plugin_dir_path( dirname( __FILE__ ) ) . 'includes/class-jco-asciinema-player-loader.php';

		/**
		 * The class responsible for defining internationalization functionality
		 * of the plugin.
		 */
		require_once plugin_dir_path( dirname( __FILE__ ) ) . 'includes/class-jco-asciinema-player-i18n.php';

		/**
		 * The class responsible for defining all actions that occur in the admin area.
		 */
		require_once plugin_dir_path( dirname( __FILE__ ) ) . 'admin/class-jco-asciinema-player-admin.php';

		/**
		 * The class responsible for defining all actions that occur in the public-facing
		 * side of the site.
		 */
		require_once plugin_dir_path( dirname( __FILE__ ) ) . 'public/class-jco-asciinema-player-public.php';
	 ...
	 *
	 * Uses the Jco_Asciinema_Player_i18n class in order to set the domain and to register the hook
	 * with WordPress.
	 *
	 * @since    1.0.0
	 * @access   private
	...
	private function set_locale() {
		...
		$plugin_i18n = new Jco_Asciinema_Player_i18n();
	 ...
	 *
	 * @since     1.0.0
	 * @return    Jco_Asciinema_Player_Loader    Orchestrates the hooks of the plugin.
	 */
